...
var app = (function () {
    ...
    // (22:2) <Button type="submit" size="normal">
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(22:2) <Button type=\\\"submit\\\" size=\\\"normal\\\">",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$5, 16, 0, 368);
    ...
    // (52:2) {#each meetups as meetup, i (meetup.id)}
    function create_each_block(key_1, ctx) {
    	let first;
    	let current;
    	const event_spread_levels = [/*meetup*/ ctx[5]];
    	let event_props = {};
    	...
    	event.$on("click", /*onAddToFavorite*/ ctx[3]);
    	event.$on("message", /*handleMessage*/ ctx[4]);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(52:2) {#each meetups as meetup, i (meetup.id)}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	let t5;
    	let b;
    	let t6_value = /*favoriteEvents*/ ctx[1].length + "";
    	let t6;
    	let t7;
    	let current;
    	...
    	updateevent.$on("newEvent", /*onAddEvent*/ ctx[2]);
    	...
    	const block = {
    		c: function create() {
    			...
    			b = element("b");
    			t6 = text(t6_value);
    			t7 = text(" favorite events.");
    			add_location(hr0, file$6, 47, 2, 1121);
    			attr_dev(div, "class", "row");
    			add_location(div, file$6, 50, 2, 1179);
    			add_location(hr1, file$6, 56, 2, 1340);
    			add_location(b, file$6, 57, 11, 1358);
    			add_location(section, file$6, 42, 0, 1032);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			check_outros();
    			if ((!current || dirty & /*favoriteEvents*/ 2) && t6_value !== (t6_value = /*favoriteEvents*/ ctx[1].length + "")) set_data_dev(t6, t6_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	return [meetups, favoriteEvents, onAddEvent, onAddToFavorite, handleMessage];
    }
