...
var app = (function () {
    ...
    var meetupStore = createEventStore();
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t = text(/*title*/ ctx[0]);
    			attr_dev(h1, "class", "svelte-17fkjfg");
    ...
    // (30:10) <Button type="button" size="small" on:click={onShowDetails}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(30:10) <Button type=\\\"button\\\" size=\\\"small\\\" on:click={onShowDetails}>",
    		ctx
    	});
    ...
    // (31:10) <Button type="button" size="small" on:click>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(31:10) <Button type=\\\"button\\\" size=\\\"small\\\" on:click>",
    		ctx
    	});
    ...
    // (32:10) <Button type="button" size="small" on:click={onRemove}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(32:10) <Button type=\\\"button\\\" size=\\\"small\\\" on:click={onRemove}>",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	button2.$on("click", /*onRemove*/ ctx[4]);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$3, 23, 4, 519);
    			attr_dev(h5, "class", "card-title");
    			add_location(h5, file$3, 25, 6, 602);
    			attr_dev(p, "class", "card-text");
    			add_location(p, file$3, 26, 6, 644);
    			attr_dev(div0, "class", "btn-group");
    			add_location(div0, file$3, 28, 8, 758);
    			attr_dev(small, "class", "text-muted");
    			add_location(small, file$3, 33, 8, 1045);
    			attr_dev(div1, "class", "d-flex justify-content-between align-items-center");
    			add_location(div1, file$3, 27, 6, 686);
    			attr_dev(div2, "class", "card-body");
    			add_location(div2, file$3, 24, 4, 572);
    			attr_dev(div3, "class", "card mb-4 shadow-sm");
    			add_location(div3, file$3, 22, 2, 481);
    			attr_dev(div4, "class", "col-md-4");
    			add_location(div4, file$3, 21, 0, 456);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*date*/ 4) set_data_dev(t8, /*date*/ ctx[2]);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [title, subtitle, date, onShowDetails, onRemove, id, dispatch, click_handler];
    }

    class Event extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$3, safe_not_equal, { id: 5, title: 0, subtitle: 1, date: 2 });
    ...
    /* src/Meetups/UpdateEvent.svelte generated by Svelte v3.16.7 */
    const file$5 = "src/Meetups/UpdateEvent.svelte";

    // (23:2) <Button type="submit" size="normal">
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(23:2) <Button type=\\\"submit\\\" size=\\\"normal\\\">",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	textinput0.$on("input", /*input_handler*/ ctx[5]);
    	...
    	textinput1.$on("input", /*input_handler_1*/ ctx[6]);
    	...
    	textinput2.$on("input", /*input_handler_2*/ ctx[7]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$5, 17, 0, 436);
    			dispose = listen_dev(form, "submit", prevent_default(/*onAddEvent*/ ctx[3]), false, true, false);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class UpdateEvent extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const file$6 = "src/Meetups/Meetups.svelte";
    ...
    function create_each_block(key_1, ctx) {
    	let first;
    	let current;
    	const event_spread_levels = [/*meetup*/ ctx[4]];
    	let event_props = {};
    	...
    	event.$on("click", /*onAddToFavorite*/ ctx[2]);
    	event.$on("message", /*handleMessage*/ ctx[3]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			? get_spread_update(event_spread_levels, [get_spread_object(/*meetup*/ ctx[4])])
    			: {};
    ...
    function create_fragment$6(ctx) {
    	...
    	const updateevent = new UpdateEvent({ $$inline: true });
    	...
    	const get_key = ctx => /*meetup*/ ctx[4].id;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			create_component(updateevent.$$.fragment);
    			t1 = space();
    			...
    			add_location(div, file$6, 33, 2, 727);
    			add_location(b, file$6, 39, 11, 902);
    			add_location(section, file$6, 27, 0, 615);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(updateevent, section, null);
    		...
    		i: function intro(local) {
    			...
    			transition_in(updateevent.$$.fragment, local);
    		...
    		o: function outro(local) {
    			...
    			transition_out(updateevent.$$.fragment, local);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$7, 6, 0, 119);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
